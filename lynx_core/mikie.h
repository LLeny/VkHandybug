...
class CMikie : public CLynxBase, public IMemoryAccess
{
  public:
    ...
    void DisplaySetAttributes(void (*DisplayCallback)(void *objref, uint8_t *dispPointer, uint8_t *palettePointer), void *objref);
    ...
    inline bool ComLynxCable()
    {
        return mUART_CABLE_PRESENT;
    }
  ...
  private:
    ...
    void (*mpUART_TX_CALLBACK)(int data, void *objref);
    void *mUART_TX_CALLBACK_OBJECT;
    ...
    void (*mpDisplayCallback)(void *objref, uint8_t *dispPointer, uint8_t *palettePointer);
    void *mDisplayCallbackObject;
