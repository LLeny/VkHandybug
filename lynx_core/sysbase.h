...
#endif
    CErrorInterface *mError;

    ULONG mSystemCycleCount;
    ULONG mNextTimerEvent;
    ULONG mCPUWakeupTime;
    ULONG mIRQEntryCycle;
    ULONG mCPUBootAddress;
    ULONG mBreakpointHit;
    ULONG mSingleStepMode;
    ULONG mSingleStepModeSprites;
    ULONG mSystemIRQ;
    ULONG mSystemNMI;
    ULONG mSystemCPUSleep;
    ULONG mSystemCPUSleep_Saved;
    ULONG mSystemHalt;
    ULONG mThrottleMaxPercentage;
    ULONG mThrottleLastTimerCount;
    ULONG mThrottleNextCycleCheckpoint;
    volatile ULONG mTimerCount;
    ULONG mAudioEnabled;
