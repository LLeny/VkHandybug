...
VkDescriptorPoolCreateInfo vkinit::descriptor_pool_create_info(VkDescriptorPoolCreateFlags flags, uint32_t maxSets, uint32_t poolSizeCount, VkDescriptorPoolSize *poolsize)
{
...
VkDescriptorSetAllocateInfo vkinit::descriptorset_allocate_info(VkDescriptorPool descriptorPool, const VkDescriptorSetLayout *pSetLayouts, uint32_t descriptorSetCount)
{
...
VkComputePipelineCreateInfo vkinit::computepipeline_create_info(VkPipelineLayout layout, VkPipelineCreateFlags flags)
{
...
VkImageMemoryBarrier vkinit::image_memory_barrier(VkImageLayout oldLayout, VkImageLayout newLayout, VkImage image)
{
